            ...
            <div class="flex">
                ...
                <div class="ml-4" id="">
                    <div class="flex flex-col md:flex-row ">
                        ...
                        <a href="" class="font-semibold p-2 rounded hover:bg-gray-400 hover:text-white">Contatos</a>

                        <a href="" class="font-semibold p-2 rounded hover:bg-gray-400 hover:text-white">Sobre Nós</a>
                    </div>
                </div>
