<div>
    <div class="flex-1 p-5 bg-white rounded-md">
                ...
                @foreach ($pedidos as $pedido)
                    <div x-data="{ pedido: false }" wire:key="{{ $pedido->id }}"
                        ...
                        <div class="flex justify-between items-center w-full">
                            ...
                            <span class="font-semibold border rounded-full p-2 ml-10">Pedido em
                                {{ $pedido->status }}</span>
        ...
        @else
            <div class="flex flex-col items-center py-5 mt-9">
                <p class="text-center font-semibold tracking-wide text-lg text-gray-800">Não há nada aqui. Parece ser uma boa hora para começar a comprar =)</p>

                <a href="{{ route('ecommerce.produtos') }}" class="font-semibold text-white bg-purple-600 p-2 mt-6 rounded">
                    Ir ao Cardapio
                </a>
            </div>
        @endif
