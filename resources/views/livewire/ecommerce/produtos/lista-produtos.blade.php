            ...
            <div class="relative grid grid-cols-2 gap-2 my-4">
                ...
                <div class="flex flex-col gap-1 dark:text-white">
                    ...
                    <div class="absolute bottom-1 flex gap-1">
                        ...
                        <button x-on:click="Livewire.dispatchTo('ecommerce.ecommerce.carrinho-botao', 'adicionarItem', {codigo:'{{ $produto->id }}', nome:'{{ $produto->nome }}', descricao:'{{ $produto->descricao }}', quantidade: '1', preco:'{{ $produto->preco }}'})"
