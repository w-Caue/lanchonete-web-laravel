<div>
    ...
    <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4" wfd-id="87">
        ...
        <!-- Card -->
        <a href="{{ route('admin.configuracao.users') }}" class="hover:shadow-lg" title="Total de clientes que você tem acesso">
            <x-card.icon-card title="Usuários" subtitle="" color="blue">
                <x-icons.users />
            </x-card.icon-card>
        </a>

        {{-- <a href="" class="hover:shadow-lg" title="Total de produtos cadastrados">
            <x-card.icon-card title="Produtos" subtitle="" color="purple">
                <x-icons.produtos />
            </x-card.icon-card>
        </a>
