            ...
            <div class="fixed top-11 bg-white w-80 sm:w-1/2 shadow-2xl rounded-lg overflow-auto max-h-screen">
                ...
                <form wire:submit.prevent="finalizarPedido()">
                    ...
                    <div class="flex justify-center gap-2 mb-2">
                        <button type="submit" class="font-semibold p-2 border rounded hover:bg-blue-500 hover:text-white">
                            Finalizar Pedido
                        </button>
                    </div>
                </form>
                    ...
                    <form wire:submit.prevent="adicionarItem({{ $itemPedido->id }})" class="">
                        <div class="mb-3">
                            ...
                            <div class="flex gap-1 flex-wrap">
                                ...
                                <input wire:model="quantidade" class="text-center font-semibold w-14" type="number"
