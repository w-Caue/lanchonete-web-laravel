        ...
        @slot('body')
            ...
            <div class="flex flex-wrap gap-3 my-2">
                @foreach ($pessoas as $pessoa)
                    <div wire:click="selecionarCliente({{ $pessoa->id }})" class="cursor-pointer">
                        <div class="text-white bg-white rounded-lg md:w-40 hover:bg-gray-100 dark:bg-gray-700 transition-all hover:scale-95">
                            <div class="flex flex-col justify-between p-4 leading-normal">
                                <p class="font-semibold text-blue-500 ">#{{ $pessoa->id }}</p>
                                <h5 class="text-xl font-bold tracking-tight">
                                    {{ $pessoa->nome }}</h5>
                                <p class="font-semibold text-gray-300 ">{{ $pessoa->whatsapp }}</p>
                            </div>
                        </div>
                    </div>
                @endforeach
