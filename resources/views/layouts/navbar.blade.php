    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                <button x-on:click="toggleSidebar()" id="toggleSidebarMobile" aria-expanded="true" aria-controls="sidebar"
            ...
            <div class="flex items-center">
                ...
                <!-- Apps -->
                <button x-on:click="toggleAppsMenu()" type="button" data-dropdown-toggle="apps-dropdown"
                ...
                <!-- Dropdown menu -->
                <template x-if="isAppsMenuOpen">
                    <div x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100"
                        x-transition:leave-end="opacity-0"
                        class="z-50 fixed right-1 top-14 max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:bg-gray-700 dark:divide-gray-600">
                        <div
                ...
                <button x-on:click="darkMode()" data-tooltip-target="tooltip-toggle" type="button"
                ...
                <div class="flex items-center ml-3">
                    <div>
                        <button x-on:click="toggleUser()" type="button"
                    ...
                    <template x-if="isUserOpen">
                        <div class="z-50 fixed right-1 top-14 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                            id="dropdown-2">
