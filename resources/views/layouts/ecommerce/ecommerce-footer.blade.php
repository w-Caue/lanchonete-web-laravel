            ...
            <div class="w-full px-4 sm:w-1/2 lg:w-3/12">
                <div class="w-full mb-10">
                    ...
                    <div class="flex items-center mb-6">
                        <a href="javascript:void(0)"
                            class="flex items-center justify-center w-8 h-8 mr-3 border rounded-full text-dark hover:border-primary hover:bg-primary border-stroke dark:hover:border-primary hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
