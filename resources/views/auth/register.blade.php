    ...
    <div class="">
        <div class="flex flex-col">
            ...
            <div class="flex justify-center">
                <div class="w-1/2 m-4 rounded-xl shadow-lg">
                    <form method="POST" action="{{ route('register') }}" class="bg-white rounded px-8 pt-6 pb-8 mb-4">
                        ...
                        <div class="flex flex-wrap -mx-3 mb-3">
                            ...
                            <div class="flex flex-wrap ">
                                <div class="w-44 px-3 mb-3 md:mb-0">
                                    <label for="telefone"
                                ...
                                <div class="w-full md:w-1/3 px-3 mb-2 md:mb-0">
                                    <label for="password"
                                        class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">{{ __('Senha') }}</label>
                                ...
                                <div class="w-full md:w-1/3 px-3 mb-2 md:mb-0">
                                    <label for="password-confirm"
                                        class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">{{ __('Confirma a Senha') }}</label>
