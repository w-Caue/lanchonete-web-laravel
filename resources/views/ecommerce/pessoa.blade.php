...
@section('content')
    <div class="py-1 text-center mt-16">
        ...
        <div class="flex justify-center m-1">
            <div class="flex flex-row content-center justify-center p-4">
                ...
                <!--Arrow -->
                <button
                    class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-500 transition-colors duration-150"
                    aria-label="Edit">
    ...
    @livewire('Ecommerce.Pessoa.Cliente')
@endsection
